...
import com.example.ecommerce.ui.ListActivity;
...
public class PaginationAdapterListActivity extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PaginationAdapterListActivity(ListActivity context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                View viewItem = inflater.inflate(R.layout.item_list_activity, parent, false);
                viewHolder = new MovieVH(viewItem);
                break;
            case LOADING:
                View viewLoading = inflater.inflate(R.layout.item_progress_activity, parent, false);
...
*/
            ...
            case ITEM:
                ...
                movieVH.userScore.setText((result.getVoteAverage()*10)+"%");
                if(result.getVoteCount() == 0){
                    movieVH.textViewPrice.setText(("₹ 400"));
                }else {
                    movieVH.textViewPrice.setText(("₹ "+result.getVoteCount()));
                }
